...
/**
 * ReaderCreationException is thrown when an abnormal condition is detected when creating 
 * a reader for inbound payload.
 * 
 * @author wdeng
 *
 */
public class ReaderCreationException extends BindingException {
	/**
	 * serial version UID.
	 */
	...
	/**
     * Constructs a <code>ReaderCreationException</code> with the payload type and cause. 
	 * 
	 ...
	 */
	public ReaderCreationException (String payloadType, Throwable t) {
		super(t);
