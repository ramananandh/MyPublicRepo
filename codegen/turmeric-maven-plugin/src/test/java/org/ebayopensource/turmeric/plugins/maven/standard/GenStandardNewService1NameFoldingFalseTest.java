 ...
 */
public class GenStandardNewService1NameFoldingFalseTest extends
		BaseGenInterfaceFromWsdlMojoTestCase {
	@Override
	public String getTestMojoDirName() {
		return "standard/NewServiceV1NameFoldingFalse";
	}

	@Test
	public void testStandardGenInterfaceNameFoldingFalse() throws Exception {
