...
/**
 * Test Namefolding as legacy true and enableNamespaceFolding  false
 */
public class GenLegacyNewService1NameFoldingFalseTest extends
		BaseGenInterfaceFromWsdlMojoTestCase {
	@Override
	public String getTestMojoDirName() {
		return "legacy/NewServiceV1NameFoldingFalse";
	}

	@Test
	public void testLegacyGenInterfaceNameFoldingFalse() throws Exception {
