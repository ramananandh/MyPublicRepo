...
public class ErrorDataCollection {
    ...
    public final static CommonErrorData svc_factory_cannot_create_svc = createCommonErrorData(1000L, (ErrorSeverity.ERROR), (ErrorCategory.SYSTEM), "svc_factory_cannot_create_svc", "security", "System", (null));
