...
import org.ebayopensource.turmeric.tools.codegen.external.wsdl.parser.DefaultWSDLLocatorImpl;
...
public class Parser {
    ...
    private static Hashtable<String,ArrayList> baseImportPairTable = new Hashtable<String,ArrayList>();
     ...
     * than this method
     */
    public static void getTypeMappings(Definition def, Map table) throws WSDLParserException {
     ...
     * than this method
     */
    public static void getTypeMappings(Definition def, Map table, ClassLoader loader) throws WSDLParserException {
                WSDLLocator     locator = new DefaultWSDLLocatorImpl((String) null, (String) null, loader);
    ...
    public static void getTypeMappings(
        ...
        Map table,
        ClassLoader loader,
        boolean includeStandardMappings) throws WSDLParserException {
                WSDLLocator     locator = new DefaultWSDLLocatorImpl((String) null, (String) null, loader);
     ...
     * than this method
     */
    public static void getTypeMappings(Definition def, Map table, WSDLLocator loc) throws WSDLParserException {
	...
	public static void getTypeMappings(
        ...
        WSDLLocator loc) throws WSDLParserException {

                //Trc.entry(null, def, table, new Boolean(includeStandardMappings), loc);
                if (loc == null) {
                        loc = new DefaultWSDLLocatorImpl((String) null, (String) null, null);
                }
                    ...
                    if (st.isArray()) {
                        ...
                        if (st instanceof ElementType) {
                            ...
                            if (baseType != null) {
                                ...
                                classNameBuilder.append("Element");
                                if (className != null) {
                                    table.put(typeName, classNameBuilder.toString());
                                }
                            }
                        } else {
     ...
     * @exception A WSDLParserException is thrown if a problem occurs when parsing the schemas
     */
    @SuppressWarnings("unchecked")
	public static void getAllSchemaTypes(
        ...
        try {
            ...
            if (loc == null) {
                loc =
                    new DefaultWSDLLocatorImpl((String) null, (String) null, null);
            }
	...
	private static void populateWithStandardMappings(
        ...
        if (schemaURI.equals(WSDLParserConstants.NS_URI_2001_SCHEMA_XSD)) {
        ...
        if (oneTimeAdds) {
            ...
            t.put(
                ...
                "java.lang.Byte");
            t.put(new QName(WSDLParserConstants.NS_URI_SOAP_ENC, "base64"), "[B");
     ...
     */
    @SuppressWarnings("unchecked")
	public static void getTypesSchemas(Definition def, List schemas, WSDLLocator loc) throws WSDLParserException {

    	baseImportPairTable.clear();//this table has to be cleared before calling the method getImportedSchemas()
...
//                    (UnknownExtensibilityElement) nextEl;
     ...
     */
    @SuppressWarnings("unchecked")
	private static void getImportedSchemas(String base, String rel, WSDLLocator loc, List schemaList) throws WSDLParserException  {
    	InputSource inputSource = null;
        try {
            inputSource = loc.getImportInputSource(base, rel);
            if (inputSource == null) {
                throw new WSDLParserException("Unable to read schema file "+rel+" relative to "+base);
            }
            
            if(baseImportPairTable.containsKey(base)){
            	ArrayList imports = baseImportPairTable.get(base);
            	if(imports.contains(rel))
            		return; // The schema corresponding to this import has already been processed for this base, hence return.
            	else
            	   imports.add(rel);	
            	...
            	newImports.add(rel);
            	baseImportPairTable.put(base, newImports);
            }
            ...
            if (el != null) {
                ...
                //Trc.exception(e);
                if (e instanceof WSDLParserException) {
                        throw (WSDLParserException) e;
                } else {
                        throw new WSDLParserException("Error when getting imported schemas", e);
                }
        } finally {
        	CodeGenUtil.closeQuietly(inputSource);
        }
    }
    ...
    private static String resolveClassName(QName qn) {
        ...
        String packageName =
            WSDLParserUtil.getPackageNameFromNamespaceURI(namespace);
        String className = WSDLParserUtil.getJavaClassNameFromXMLName(localPart);
        if (packageName != null
            && !packageName.equals("")
            && className != null
            && !className.equals("")) {
    ...
    private static String getWrapperClassName(QName qn) {
        ...
        if (WSDLParserConstants.NS_URI_1999_SCHEMA_XSD.equals(ns)
            || WSDLParserConstants.NS_URI_2000_SCHEMA_XSD.equals(ns)
            || WSDLParserConstants.NS_URI_2001_SCHEMA_XSD.equals(ns)) {
