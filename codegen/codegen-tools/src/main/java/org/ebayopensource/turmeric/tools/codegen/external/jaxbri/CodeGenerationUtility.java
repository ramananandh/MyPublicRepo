...
import org.ebayopensource.turmeric.tools.codegen.external.ObjectFactoryClassContentsSorter;
 ...
 * @author rkulandaivel
 *
 *	This class is the replica of org.apache.axis2.jaxbri.CodeGenerationUtility
 *	with small changes. 
 *	CodeGenerationUtility does Java files generation in two steps. Parse the schema and generate files from the parse model.
 *	So this custom CodeGenerationUtility puts a hook in between the steps to sort the contents of class ObjectFactory.
 *
 *	Uses ObjectFactoryClassContentsSorter to sort contents of ObjectFactoryClass.
 */
public class CodeGenerationUtility {
    ...
    private static boolean createDir(File outputDir){
