...
/**
 * ServiceContext extensions for client-side service contexts.
 * 
 * @author ichernyshev
 */
public interface ClientServiceContext extends ServiceContext {
	/**
	 * Returns custom response handler if any, or null.
