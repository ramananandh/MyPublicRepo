 ...
 * @author ichernyshev
 */
public abstract class BaseCustomError2LocalTest extends AbstractWithServerTest {
	...
	public BaseCustomError2LocalTest(String config, String clientName) {
		m_config = config;
	...
	public void test1Exception() throws Exception {
		...
		driver.setExpectedError(ErrorDataCollection.svc_rt_application_internal_error.getErrorId(), 
			MyMessage.class, Test1Exception.class, "Test1Exception: Our test1 exception");
		driver.doCall();
	}
