...
public class RemoteVersionSameMajorAsCurrentTest extends BaseVersionTest {

	public RemoteVersionSameMajorAsCurrentTest() throws Exception {
		super("configremote");
	}

	protected void setupDriver(Test1Driver driver) {
		driver.setServiceVersion("1.2.0");
