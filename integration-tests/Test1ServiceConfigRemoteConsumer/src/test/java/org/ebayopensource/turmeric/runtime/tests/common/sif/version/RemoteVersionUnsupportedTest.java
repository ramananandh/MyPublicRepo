...
public class RemoteVersionUnsupportedTest extends BaseVersionTest {

	public RemoteVersionUnsupportedTest() throws Exception {
		super("configremote");
	}
	...
	protected void setupDriver(Test1Driver driver) {
		...
		driver.setExpectedError(
				ErrorDataCollection.svc_rt_version_unsupported.getErrorId(),
				ServiceInvocationException.class,
				ServiceInvocationRuntimeException.class,
				"version 2.1.0 is unsupported");
	}
}
