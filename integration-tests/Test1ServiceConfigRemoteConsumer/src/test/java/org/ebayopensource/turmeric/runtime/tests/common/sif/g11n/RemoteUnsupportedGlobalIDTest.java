 ...
 *
 */
public class RemoteUnsupportedGlobalIDTest extends BaseG11nTest {

	public RemoteUnsupportedGlobalIDTest() throws Exception {
		super("configremote");
	}
	...
	protected void setupDriver(Test1Driver driver) {
		...
		driver.setExpectedError(
				ErrorDataCollection.svc_g11n_unsupported_global_id.getErrorId(),
				ServiceInvocationException.class,
				ServiceInvocationRuntimeException.class,
				"Service does not support global ID");
	}
}
