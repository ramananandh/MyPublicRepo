...
public class RemoteVersionNonnumericTest extends BaseVersionTest {

	public RemoteVersionNonnumericTest() throws Exception {
		super("configremote");
	}

	protected void setupDriver(Test1Driver driver) {
		driver.setServiceVersion("A.1");
		driver.setExpectedError(
				ErrorDataCollection.svc_rt_invalid_version_format.getErrorId(),
				ServiceInvocationException.class,
				ServiceInvocationRuntimeException.class,
				"Invalid version format A.1");
	}
}
