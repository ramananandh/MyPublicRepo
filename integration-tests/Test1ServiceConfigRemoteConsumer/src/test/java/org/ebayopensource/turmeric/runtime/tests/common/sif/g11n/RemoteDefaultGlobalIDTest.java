 ...
 *
 */
public class RemoteDefaultGlobalIDTest extends BaseG11nTest {

	public RemoteDefaultGlobalIDTest() throws Exception {
		super("configremote");
	}
	...
	protected void setupDriver(Test1Driver driver) {
		...
		G11nOptions options = new G11nOptions(charset, null, null);
		driver.setG11nOptions(options);
		driver.setVerifier(new BaseG11nTest.Verifier("US-ASCII", "en-US_US", null));
	}
}
