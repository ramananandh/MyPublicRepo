 ...
 *
 */
public class RemoteUnsupportedLocaleTest extends BaseG11nTest {

	public RemoteUnsupportedLocaleTest() throws Exception {
		super("configremote");
	}
	...
	protected void setupDriver(Test1Driver driver) {
		...
		driver.setExpectedError(
				ErrorDataCollection.svc_g11n_unsupported_locale.getErrorId(),
				ServiceInvocationException.class,
				ServiceInvocationRuntimeException.class,
				"Service does not support locale");
	}
}
