 ...
 *
 */
public class RemoteInvalidLocaleTest extends BaseG11nTest {

	public RemoteInvalidLocaleTest() throws Exception {
		super("configremote");
	}
	...
	protected void setupDriver(Test1Driver driver) {
		...
		driver.setExpectedError(
				ErrorDataCollection.svc_g11n_no_such_locale.getErrorId(),
				ServiceInvocationException.class,
				ServiceInvocationRuntimeException.class, "No such locale");
	}
