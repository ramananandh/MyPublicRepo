 ...
 * 					
 * 
 * <p>Java class for CompositeLogicalExpression complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CompositeLogicalExpression">
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.ebay.com/marketplace/search/v1/services}LogicalExpressionBase">
 *       &lt;sequence>
 *         &lt;element name="operator" type="{http://www.ebay.com/marketplace/search/v1/services}CompositeOperator"/>
...
@XmlType(name = "CompositeLogicalExpression", propOrder = {
    "operator",
    "operand"
})
public class CompositeLogicalExpression
    extends LogicalExpressionBase
{

    @XmlElement(required = true)
    protected CompositeOperator operator;
    @XmlElement(required = true)
     ...
     *     
     */
    public void setOperator(CompositeOperator value) {
        this.operator = value;
    }
