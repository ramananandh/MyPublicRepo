...
/**
 * <p>Java class for DFNSortType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="DFNSortType">
 ...
 * 
 */
@XmlType(name = "DFNSortType")
@XmlEnum
public enum DFNSortType {
    ...
    public static DFNSortType fromValue(String v) {
        for (DFNSortType c: DFNSortType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
