 ...
 * 
 */
public class InvalidGlobalID extends BaseG11nTest {

	public InvalidGlobalID() throws Exception {
		super("local");
	}
	...
	protected void setupDriver(Test1Driver driver) {
		...
		driver.setExpectedError(ErrorDataCollection.svc_g11n_no_such_global_id.getErrorId(), 
