 ...
 *
 */
public class InvalidLocale extends BaseG11nTest {

	public InvalidLocale() throws Exception {
		super("local");
	}

	protected void setupDriver(Test1Driver driver) {
		List<String> locales = new ArrayList<String>();
		locales.add("BAD_LOCALE");
		Charset charset = Charset.forName("US-ASCII");
		G11nOptions options = new G11nOptions(charset, locales, "EBAY-US");
		driver.setG11nOptions(options);
		driver.setExpectedError(ErrorDataCollection.svc_g11n_no_such_locale.getErrorId(),  
				ServiceInvocationException.class, ServiceInvocationRuntimeException.class, "No such locale");
	}
