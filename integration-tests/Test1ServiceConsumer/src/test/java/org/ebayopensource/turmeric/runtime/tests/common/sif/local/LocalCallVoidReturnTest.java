 ...
 * @author wdeng
 */
public class LocalCallVoidReturnTest extends BaseCallTest {
    @Rule
    public NeedsConfig needsconfig = new NeedsConfig("config");

	public LocalCallVoidReturnTest() throws Exception {
		super();
	}
	...
	protected Test1Driver createDriver() throws Exception {
		Test1Driver driver = new Test1Driver(Test1Driver.TEST1_ADMIN_NAME,
				...
				Test1Driver.OP_NAME_myVoidReturnOperation);
		driver.setLocalVoidReturnTest(true);
		return driver;
	}
}
